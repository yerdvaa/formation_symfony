...
(function(){
	...
	Chart.Type = function(data,options,chart){
		...
		// By default_old it is a no op, but it should be extended
	...
	Chart.Type.extend = function(extensions){
		...
		if (extensions.name || parent.prototype.name){
			...
			//Assign any potential default_old values of the new chart type
	...
	Chart.Animation = Chart.Element.extend({
		...
		numSteps: 60, // default_old number of steps
...
(function(){
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			//Declare the extension of the default_old point, to cater for the options passed in to the constructor
