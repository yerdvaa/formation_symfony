...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	this.s = {
		 ...
		 *  @type     object
		 *  @default_old  Passed in as first parameter to constructor
		 */
		"dt": oDTSettings,
...
/**
 * Scroller default_old settings for initialisation
 *  @namespace
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * something in the middle - the default_old factor of 0.5 is usually suitable.
	 *  @type     float
	 *  @default_old  0.5
	 *  @static
	 *  @example
